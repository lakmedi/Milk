...
Begin VB.Form frmReportsExpences 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmReportsExpences.frx":0000
      ...
      TabPicture(1)   =   "frmReportsExpences.frx":001C
   ...
   End
End
Attribute VB_Name = "frmReportsExpences"
...
Private Sub bttnCreate_Click()
    ...
    For i = 0 To ItemCount - 1
        ...
        temSQL = temSQL & "WHERE Deleted = 0  AND CollectingCenterID = " & ArrayItemIDs(i) & " AND ExpenceDate Between '" & Format(dtpFrom.Value, "dd MMMM yyyy") & "' And '" & Format(dtpTo.Value, "dd MMMM yyyy") & "' "
        If rsProduction.State = 1 Then rsProduction.Close
        ...
        If rsProduction.RecordCount > 0 Then
            If Not IsNull(rsProduction!DisplayValue) Then
                myworksheet.Cells(2, i + 2) = rsProduction!DisplayValue
            End If
        End If
        If rsProduction.State = 1 Then rsProduction.Close
        DoEvents
    Next
    mychart.SetSourceData myworksheet.Range("B1:" & GetColumnName(i + 1) & "2")
