...
Begin VB.Form frmReportCollectingCenterviceMilkCollection 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Milk Collection - Collecting Centers"
   ClientHeight    =   6855
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   6915
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmReportCollectingCenterviceMilkCollection.frx":0000
      ...
      TabPicture(1)   =   "frmReportCollectingCenterviceMilkCollection.frx":001C
   ...
   End
End
Attribute VB_Name = "frmReportCollectingCenterviceMilkCollection"
...
' SELECT Sum(tblCollection.Liters) AS SumOfLiters, Sum(tblCollection.Value) AS SumOfValue, Sum(tblCollection.Commision) AS SumOfCommision
' From tblCollection
' WHERE (((tblCollection.CollectingCenterID)=1) AND ((tblCollection.ProgramDate) Between #1/1/2008# And #12/31/2008#));
                    ...
                    temWHERE = "WHERE (((tblCollection.ProgramDate) Between '" & Format(myworksheet.Cells((ii + 2), 1), "dd MMMM yyyy") & "' And '" & Format(myworksheet.Cells(ii + 2, 2), "dd MMMM yyyy") & "')  AND ((tblCollection.CollectingCenterID)=" & ArrayItemIDs(i) & ") And ((tblCollection.Deleted) = 0 ))"
