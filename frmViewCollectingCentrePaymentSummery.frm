...
Begin VB.Form frmViewCollectingCentrePaymentSummery 
   ...
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   Picture         =   "frmViewCollectingCentrePaymentSummery.frx":0000
   ScaleHeight     =   9435
   ScaleWidth      =   13425
   ...
   End
End
Attribute VB_Name = "frmViewCollectingCentrePaymentSummery"
        ...
        End With
            ...
            If rsCenter.RecordCount > 0 Then
                ...
                While rsCenter.EOF = False
                    ...
                    If MyMilkCollectionM.Value <> 0 Or temOwnCommision <> 0 Or MyMilkCollectionE.Value <> 0 Or temOthersCommision <> 0 Or SupplierDeduction <> 0 Then
                        With gridSummery
                            .Rows = .Rows + 1
                            .row = .Rows - 1
                            .col = 0
                            ...
                            If temOwnCommision <> 0 Or temAdditionalCommision <> 0 Or temOthersCommision <> 0 Or temAdditionalCommision <> 0 Then .Text = Format(temOwnCommision + temOthersCommision + temAdditionalCommision, "0.00")
