...
Begin VB.Form frmCumulativeDailyMilkCollectionAll 
   ...
   End
End
Attribute VB_Name = "frmCumulativeDailyMilkCollectionAll"
...
Private Sub btnStoreReport_Click()
    ...
    If SelectForm(cmbPaper.Text, Me.hdc) = 1 Then
        ...
        Printer.Font.Bold = True
        Printer.Print
        Printer.Print Tab(tab1); "All Collecting Centesr ";
        Printer.Print Tab(tab2); "";
...
Private Sub bttnPrint_Click()
    ...
    If SelectForm(cmbPaper.Text, Me.hdc) = 1 Then
        ...
        Printer.Print Tab(tab1); "All Collecting Centers ";
        Printer.Print Tab(tab2); ""
        Printer.Print Tab(tab1); "From  :";
        Printer.Print Tab(tab2); dtpFrom.Value;
        Printer.Print Tab(tab3); "To  :";
...
Private Sub FillGrid()
    ...
    For i = 1 To NoOfDays
        ...
        With rsDailyCollection
            ...
            temSQL = "SELECT tblDailyCollection.* FROM tblDailyCollection Where ProgramDate = '" & Format(ThisDate, "dd MMMM yyyy") & "'  order by tblDailyCollection.DailyCollectionID DESC"
