...
Private Sub btnDelete_Click()
    ...
    With rsDelete
        ...
        temSql = "Select * from tblExpenceCategory where ExpenceCategoryID = " & Val(cmbCategory.BoundText)
...
Private Sub DisplayDetails()
    ...
    With rsDisplay
        ...
        If .RecordCount > 0 Then
            If Not IsNull(!expenceCategory) Then
                txtCategory.Text = !expenceCategory
            End If
        End If
        .Close
    End With
...
Private Sub SaveNew()
    ...
    With rsEdit
        If .State = 1 Then .Close
        temSql = "Select * from tblExpenceCategory"
        .Open temSql, cnnStores, adOpenStatic, adLockOptimistic
        .AddNew
        !expenceCategory = txtCategory.Text
        .Update
        .Close
    End With
    Set rsEdit = Nothing
