...
Private Sub FillGrid()
    ...
    With rsIncome
        If .State = 1 Then .Close
        temSQL = "SELECT tblIncome.*, tblIncomeCategory.IncomeCategory FROM tblIncome LEFT JOIN tblIncomeCategory ON tblIncome.IncomeCategoryID = tblIncomeCategory.IncomeCategoryID where tblIncome.IncomeDate = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "' And tblIncome.CollectingCenterID = " & Val(cmbCollectingCenter.BoundText) & " And tblIncome.Deleted = 0 "
