...
Begin VB.Form frmCollectingCentrePaymentSummeryAll 
   ...
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   Picture         =   "frmCollectingCentrePaymentSummeryAll.frx":0000
   ScaleHeight     =   9870
   ScaleWidth      =   13425
   ...
   End
End
Attribute VB_Name = "frmCollectingCentrePaymentSummeryAll"
...
Private Sub btnAddDeductions_Click()
    ...
    With gridSummery
        ...
        End With
            ...
            temSQL = "Select * from tblSupplier WHERE Deleted = 0  "
...
Private Sub btnPrintSummery_Click()
    ...
    If SelectForm(cmbSUmmeryPaper.Text, Me.hdc) = 1 Then
        ...
        Printer.Print Tab(tabNo); "Payment Summery For All Collecting Centres"
...
Private Sub btnExcel_Click()
    GridToExcel gridSummery, "All Collecting Centre Payment Summery From " & Format(dtpFrom.Value, "dd MMMM yyyy") & " to " & Format(dtpFrom.Value, "dd MMMM yyyy"), "All Collecting Centre Payment Summery " & " From " & Format(dtpFrom.Value, "dd MMMM yyyy") & " to " & "From " & Format(dtpFrom.Value, "dd MMMM yyyy")
End Sub
...
Private Sub cmbCollectingCenter_Change()
    ...
    With rsCCSummery
        ...
        temSQL = "SELECT Max(tblCollectingCenterPaymentSummery.ToDate) AS MaxOfToDate " & _
                    "From tblCollectingCenterPaymentSummery "
        .Open temSQL, cnnStores, adOpenStatic, adLockReadOnly
