...
Begin VB.Form frmPrintAllPayments 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Print All Payments"
   ClientHeight    =   9420
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10290
   ...
   Begin VB.ListBox lstBankValue 
      ...
      ItemData        =   "frmPrintAllPayments.frx":0000
      Left            =   4680
      List            =   "frmPrintAllPayments.frx":0002
      MultiSelect     =   2  'Extended
      TabIndex        =   4
      Top             =   1080
      Width           =   2655
   ...
   End
End
Attribute VB_Name = "frmPrintAllPayments"
...
Private Sub btnCommercialDetails_Click()
    ...
    With myExcel
        ...
        .SubTopic = "Date " & Format(dtpDate.Value, "dd MMMM yyyy")
        .Path = App.Path
...
Private Sub btnExcelSam_Click()
    ...
    With rsReport
        ...
        temSQL = "SELECT tblSupplier.Supplier, tblCity.BankCode, tblSupplier.AccountNo, tblSupplierPayments.FromDate, tblBank.BankCode, tblSupplier.AccountHolder, tblSupplier.SupplierID, tblSupplierPayments.SupplierPaymentsID, tblSupplierPayments.Value, tblSupplierPayments.GeneratedPaymentMethodID, tblBank.Bank, tblCity.City " & _
                    ...
                    "Where tblSupplierPayments.FromDate  =  '" & Format(dtpDate.Value, "dd MMMM yyyy") & "' And tblSupplier.BankID = 1 " & _
                    "ORDER BY tblSupplier.AccountHolder"
        ...
        While .EOF = False
            ...
            myworksheet.Cells(i, 4) = ![BankCode]
...
'            myworksheet.Cells(i, 20) = "@"
            ...
            Dim SaveAsName As String
            SaveAsName = App.Path & "\MilkPaymentSampathBank" & Format(dtpDate.Value, "dd MMM yyyy") & ".xls"
...
Private Sub btnPrint_Click()
    ...
    With rsReport
        ...
        temSQL = "SELECT tblSupplier.Supplier + ' (' +  tblSupplier.AccountHolder + ')' AS SupAccount , tblBank.Bank, tblSupplier.AccountNo AS Account, tblSupplierPayments.Value " & _
                    "FROM ((tblSupplier RIGHT JOIN tblSupplierPayments ON tblSupplier.SupplierID = tblSupplierPayments.SupplierID) RIGHT JOIN (tblCollectingCenter RIGHT JOIN tblCollectingCenterPaymentSummery ON tblCollectingCenter.CollectingCenterID = tblCollectingCenterPaymentSummery.CollectingCenterID) ON tblSupplierPayments.CollectingCenterPaymentSummeryID = tblCollectingCenterPaymentSummery.CollectingCenterPaymentSummeryID) LEFT JOIN tblBank ON tblSupplier.BankID = tblBank.BankID " & _
                    "Where (((tblCollectingCenterPaymentSummery.FromDate) = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "') And ((tblSupplierPayments.GeneratedPaymentMethodID) = " & 2 & ")) " & _
                    "ORDER BY tblSupplier.Supplier"
        .Open temSQL, cnnStores, adOpenStatic, adLockReadOnly
    End With
    With dtrPayAdvice
        ...
        .Sections("Section4").Controls("lblTopic").Caption = "Payment Advice On " & Format(dtpDate.Value, "dd MMMM yyyy")
        ...
        If i = vbYes Then .ExportReport , "On " & Format(dtpDate.Value, "dd MMMM yyyy") & " - Cash ", True, True
    End With
    With rsReport
        If .State = 1 Then .Close
        temSQL = "SELECT tblSupplier.Supplier + ' (' +  tblSupplier.AccountHolder + ')'  AS SupAccount , tblBank.Bank, tblSupplier.AccountNo AS Account, tblSupplierPayments.Value " & _
                    "FROM ((tblSupplier RIGHT JOIN tblSupplierPayments ON tblSupplier.SupplierID = tblSupplierPayments.SupplierID) RIGHT JOIN (tblCollectingCenter RIGHT JOIN tblCollectingCenterPaymentSummery ON tblCollectingCenter.CollectingCenterID = tblCollectingCenterPaymentSummery.CollectingCenterID) ON tblSupplierPayments.CollectingCenterPaymentSummeryID = tblCollectingCenterPaymentSummery.CollectingCenterPaymentSummeryID) LEFT JOIN tblBank ON tblSupplier.BankID = tblBank.BankID " & _
                    "Where (((tblCollectingCenterPaymentSummery.FromDate) = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "') And ((tblSupplierPayments.GeneratedPaymentMethodID) = " & 1 & ")) " & _
                    "ORDER BY tblSupplier.Supplier"
        .Open temSQL, cnnStores, adOpenStatic, adLockReadOnly
    End With
    With dtrPayAdviceBank
        ...
        .Sections("Section4").Controls("lblCenter").Caption = "On " & Format(dtpDate.Value, "dd MMMM yyyy")
        ...
        If i = vbYes Then .ExportReport , "On " & Format(dtpDate.Value, "dd MMMM yyyy") & " - Bank ", True, True
    End With
    With rsReport
        If .State = 1 Then .Close
        temSQL = "SELECT tblSupplier.Supplier + ' (' +  tblSupplier.AccountHolder + ')'  AS SupAccount , tblBank.Bank, tblSupplier.AccountNo AS Account, tblSupplierPayments.Value " & _
                    "FROM ((tblSupplier RIGHT JOIN tblSupplierPayments ON tblSupplier.SupplierID = tblSupplierPayments.SupplierID) RIGHT JOIN (tblCollectingCenter RIGHT JOIN tblCollectingCenterPaymentSummery ON tblCollectingCenter.CollectingCenterID = tblCollectingCenterPaymentSummery.CollectingCenterID) ON tblSupplierPayments.CollectingCenterPaymentSummeryID = tblCollectingCenterPaymentSummery.CollectingCenterPaymentSummeryID) LEFT JOIN tblBank ON tblSupplier.BankID = tblBank.BankID " & _
                    "Where (((tblCollectingCenterPaymentSummery.FromDate) = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "') And ((tblSupplierPayments.GeneratedPaymentMethodID) = " & 3 & ")) " & _
                    "ORDER BY tblSupplier.Supplier"
        .Open temSQL, cnnStores, adOpenStatic, adLockReadOnly
    End With
    With dtrPayAdviceCheque
        ...
        If i = vbYes Then .ExportReport , "On " & Format(dtpDate.Value, "dd MMMM yyyy") & " - Cheque ", True, True
    End With
...
Private Sub btnPrintBankC_Click()
   ...
   AccNo = "1104013300"
    ...
    With dtrPayAdviceBank
        ...
        .Sections("Section4").Controls("lblPeriod").Caption = "On " & Format(dtpDate.Value, "dd MMMM yyyy")
...
Private Sub dtpDate_Change()
    dtpFrom.Value = dtpDate.Value
    dtpTo.Value = dtpDate.Value
End Sub
    ...
    With rsSuppliers
        If optAll.Value = True Then
            temSQL = "SELECT tblSupplier.Supplier, tblSupplier.SupplierID, tblSupplierPayments.SupplierPaymentsID , tblSupplierPayments.Value ,tblSupplierPayments.GeneratedPaymentMethodID " & _
                        ...
                        "Where (((tblSupplierPayments.FromDate) = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "')) " & _
                        "ORDER BY tblSupplier.Supplier"
        ElseIf optCom.Value = True Then
            temSQL = "SELECT tblSupplier.Supplier, tblSupplier.SupplierID, tblSupplierPayments.SupplierPaymentsID , tblSupplierPayments.Value ,tblSupplierPayments.GeneratedPaymentMethodID " & _
                        "FROM tblSupplierPayments LEFT JOIN tblSupplier ON tblSupplierPayments.SupplierID = tblSupplier.SupplierID " & _
                        "Where tblSupplierPayments.FromDate  =  '" & Format(dtpDate.Value, "dd MMMM yyyy") & "' AND tblSupplier.BankID = 2 " & _
                        "ORDER BY tblSupplier.Supplier"
