...
Begin VB.Form frmReportAdditionalCommision 
   ...
   End
End
Attribute VB_Name = "frmReportAdditionalCommision"
...
Private Sub FillGrid()
    ...
    With rsTem
        ...
        temSQL = "SELECT tblSupplier.Supplier, tblSupplier.SupplierCode, tblAdditionalCommision.AddedDate, tblAdditionalCommision.Comments, tblStaffAdded.Staff, tblAdditionalCommision.AddedValue, tblAdditionalCommision.Approved, tblStaffAutherized.Staff, tblAdditionalCommision.ApprovedComments, tblAdditionalCommision.ApprovedDate, tblAdditionalCommision.Value " & _
                    "FROM ((tblAdditionalCommision LEFT JOIN tblSupplier ON tblAdditionalCommision.SupplierID = tblSupplier.SupplierID) LEFT JOIN tblStaff AS tblStaffAdded ON tblAdditionalCommision.AddedUserID = tblStaffAdded.StaffID) LEFT JOIN tblStaff AS tblStaffAutherized ON tblAdditionalCommision.ApprovedUserID = tblStaffAutherized.StaffID " & _
                    "WHERE (((tblAdditionalCommision.AddedDate) Between '" & Format(dtpFrom.Value, "dd MMMM yyyy") & "' And '" & Format(dtpTo.Value, "dd MMMM yyyy") & "') AND ((tblSupplier.CollectingCenterID)=" & Val(cmbCC.BoundText) & "))"
...
Private Sub btnPrint_Click()
        ...
        Printer.Print
        Printer.Print Tab(tabReport); "Additional Commision Report"
