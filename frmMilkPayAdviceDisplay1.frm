...
Begin VB.Form frmMilkPayAdviceDisplay1 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmMilkPayAdviceDisplay1.frx":0000
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Grid1"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Evening"
      TabPicture(1)   =   "frmMilkPayAdviceDisplay1.frx":001C
   ...
   End
End
Attribute VB_Name = "frmMilkPayAdviceDisplay1"
...
Private Function FillGrid(ByVal SupplierID As Long, ByVal SecessionID As Long, Grid As MSFlexGrid, ByVal FromDate As Date, ByVal ToDate As Date) As MilkCollection
    ...
    If temDays < 1 Then
        MsgBox "Please select a valid time period"
        dtpFrom.SetFocus
        Exit Function
    End If
