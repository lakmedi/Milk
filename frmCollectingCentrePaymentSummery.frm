...
Begin VB.Form frmCollectingCentrePaymentSummery 
   ...
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   Picture         =   "frmCollectingCentrePaymentSummery.frx":0000
   ScaleHeight     =   9870
   ScaleWidth      =   13425
   ...
   Begin btButtonEx.ButtonEx btnSave 
      ...
      Appearance      =   3
      BackColor       =   16711680
      Caption         =   "&Add Deductions And &Save"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   9.75
         Charset         =   0
   ...
   Begin btButtonEx.ButtonEx btnPrintCommisions 
      ...
      EndProperty
   End
   Begin btButtonEx.ButtonEx btnAddDeductions 
      Height          =   375
      Left            =   10200
      TabIndex        =   33
      Top             =   600
      ...
      EndProperty
   End
   Begin btButtonEx.ButtonEx btnSaveNoD 
      Height          =   495
      Left            =   120
      TabIndex        =   34
      Top             =   8880
      ...
      Appearance      =   3
      BackColor       =   16711680
      Caption         =   "&Save without Deductions"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmCollectingCentrePaymentSummery"
...
Private Sub btnAddDeductions_Click()
...
'                            If MyMilkCollectionM.Value + MyMilkCollectionE.Value - SupplierDeduction + temOwnCommision + temOthersCommision + temAdditionalCommision < 2 Then
'                                MinusValue = True
'                                .CellBackColor = vbRed
'                            End If
                    ...
                    AutoAddDeduction SupplierID, (temValue - SupplierDeduction + temOwnCommision + temOthersCommision + temAdditionalCommision), dtpFrom.Value, MyMilkCollectionE.Liters + MyMilkCollectionM.Liters
...
'            End If
            ...
            MsgBox "Deductions are added successfully. Please process to see the results"
End Sub
...
'    End With
    ...
    With rsAP
        If .State = 1 Then .Close
        temSQL = "Select * from tblAdditionalCommision where CommisionDate between '" & dtpFrom.Value & "' AND '" & dtpTo.Value & "' AND Approved  = 0AND Deleted = 0 "
        .Open temSQL, cnnStores, adOpenStatic, adLockOptimistic
        If .RecordCount > 0 Then
                ...
                While rsCenter.EOF = False
                    ...
                    If MyMilkCollectionM.Value <> 0 Or temOwnCommision <> 0 Or MyMilkCollectionE.Value <> 0 Or temOthersCommision <> 0 Or SupplierDeduction <> 0 Or temOthersCommision <> 0 Or temAdditionalCommision <> 0 Then
                        With gridSummery
                            ...
                            temNetPayment = temNetPayment + Val(.col)
...
Private Sub btnSave_Click()
    ...
    With rsCCMilkPayment
        If .State = 1 Then .Close
        temSQL = "SELECT * FROM tblCollectingCenterPaymentSummery where CollectingCenterPaymentSummeryID =0 "
        .Open temSQL, cnnStores, adOpenStatic, adLockOptimistic
        .AddNew
...
Private Sub cmbCollectingCenter_Change()
    ...
    End With
    btnProcess.Enabled = True
    If AutoAddedDeductions(dtpFrom.Value, Val(cmbCollectingCenter.BoundText)) = True Then
