...
Begin VB.Form frmPrintCollectingCentrePaymentSummeryDisplay 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Display Collecting Center Payment Advice"
   ClientHeight    =   9915
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   13425
   ...
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   Picture         =   "frmPrintCollectingCentrePaymentSummeryDisplay.frx":0000
   ScaleHeight     =   9915
   ScaleWidth      =   13425
   ...
   End
End
Attribute VB_Name = "frmPrintCollectingCentrePaymentSummeryDisplay"
...
Private Sub btnTextFile_Click()
    ...
    temFile = txtPath.Text & "\" & cmbCCPS.Text & ".txt"
...
Private Sub cmbCCPS_KeyDown(KeyCode As Integer, Shift As Integer)
